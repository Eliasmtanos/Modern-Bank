  ...
  return (
    <section id='home' className={` flex md:flex-row flex-col ${styles.paddingY} relative`}>
        <div className={`flex-1 ${styles.flexStart} flex-col`}>
            ...
            <h1 className='font-poppins font-semibold ss:text-[66px] text-[50px] w-full text-white'>
                  Payment Method.
            </h1>
        ...
        <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
            ...
            <div className='absolute z-[1] top-0  w-[80%] h-[80%] rounded-full bottom-40 white__gradient'/>
