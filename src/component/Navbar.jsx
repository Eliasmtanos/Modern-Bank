  ...
  return (
    ...
    <nav className='w-full flex py-6 justify-between items-center navbar'>
      ...
      <ul className='list-none sm:flex hidden justify-end items-center flex-1'>
       ...
       <div className='sm:hidden flex flex-1 justify-end items-center relative z-[3]'>
        ...
        my-2 min-w-[140px] rounded-xl sidebar`}>
          <ul className='list-none flex flex-col justify-end items-center flex-1'>
         {
          Obj.navLinks.map( (nav , index)=>(
            <li key={nav.id} className={`font-poppins font-normal cursor-pointer text-[16px] text-white
            ${index === Obj.navLinks.length-1 ?'mb-0':'mb-10'}
